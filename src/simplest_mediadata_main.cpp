...
int main(int argc, char* argv[]){
	...
	simplest_yuv420_border((char*)"lena_256x256_yuv420p.yuv",256,256,20,1);

	simplest_yuv420_graybar(640, 360,0,255,10, (char*)"graybar_640x360.yuv");

	simplest_yuv420_psnr((char*)"lena_256x256_yuv420p.yuv", (char*)"lena_distort_256x256_yuv420p.yuv",256,256,1);

	simplest_rgb24_split((char*)"cie1931_500x500.rgb", 500, 500,1);

	simplest_rgb24_to_bmp((char*)"lena_256x256_rgb24.rgb",256,256, (char*)"output_lena.bmp");

	simplest_rgb24_to_yuv420((char*)"lena_256x256_rgb24.rgb",256,256,1, (char*)"output_lena.yuv");

	simplest_rgb24_colorbar(640, 360, (char*)"colorbar_640x360.rgb");

	simplest_pcm16le_split((char*)"NocturneNo2inEflat_44.1k_s16le.pcm");

	simplest_pcm16le_halfvolumeleft((char*)"NocturneNo2inEflat_44.1k_s16le.pcm");

	simplest_pcm16le_doublespeed((char*)"NocturneNo2inEflat_44.1k_s16le.pcm");

	simplest_pcm16le_to_pcm8((char*)"NocturneNo2inEflat_44.1k_s16le.pcm");

	simplest_pcm16le_cut_singlechannel((char*)"drum.pcm",2360,120);

	simplest_pcm16le_to_wave((char*)"NocturneNo2inEflat_44.1k_s16le.pcm",2,44100, (char*)"output_nocturne.wav");

	simplest_h264_parser((char*)"sintel.h264");
	
	simplest_flv_parser((char*)"cuc_ieschool.flv");
